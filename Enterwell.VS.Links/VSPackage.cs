...
namespace Enterwell.VS.Links
{
    ...
    [Guid(PackageGuids.guidLinksPackageString)]
    ...
    public sealed class VSPackage : AsyncPackage
    {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            var builder = await CommandBuilder.CreateAsync(this);
            builder.Register(PackageIds.WikiCommandId);
            builder.Register(PackageIds.AzureCommandId);
            builder.Register(PackageIds.ClockifyCommandId);

            builder.RegisterOptionButtons();
        }
    }
}
